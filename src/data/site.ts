...
export const fallbackTeamMembers: TeamMember[] = [
  {
    ...
    role: "مدیرعامل مؤسسه حقوقی مجد وکیل الرعایا",
    specialty: "حقوق بین‌الملل عمومی",
    bio: "مسعود جوکار درزی، حقوقدان و مدیرعامل مؤسسه حقوقی مجد وکیل الرعایا، متولد ۲۲ بهمن ۱۳۶۱ و ساکن شرق تهران است.",
    fullBio: [
      "مسعود جوکار درزی، حقوقدان و مدیرعامل مؤسسه حقوقی مجد وکیل الرعایا، متولد ۲۲ بهمن ۱۳۶۱ و ساکن شرق تهران است. ایشان با برخورداری از تحصیلات تخصصی در حوزه حقوق و سابقه فعالیت در عرصه‌های حقوقی، تقنینی، سیاسی، مدیریتی و بین‌المللی، در حال حاضر مسئولیت مدیریت و راهبری مؤسسه حقوقی مجد وکیل الرعایا را بر عهده دارد.",
      "مسعود جوکار درزی در مسیر حرفه‌ای خود، تجربه همکاری و ارائه خدمات مشاوره حقوقی به مجموعه‌ها و نهادهای مختلف دولتی، سیاسی، فرهنگی و ورزشی را داشته و از این تجربه در مدیریت و توسعه فعالیت‌های مؤسسه حقوقی مجد وکیل الرعایا بهره می‌گیرد.",
      "سوابق تحصیلی",
      "مسعود جوکار درزی تحصیلات خود را در رشته حقوق قضایی آغاز کرده و پس از آن در مقطع کارشناسی ارشد، در رشته حقوق جزا و جرم‌شناسی به تحصیل پرداخته است. وی در حال حاضر دانشجوی مقطع دکتری حقوق بین‌الملل عمومی است.",
      "سوابق تحصیلی ایشان عبارت است از:",
      "دکتری حقوق بین‌الملل عمومی – دانشجو",
      "کارشناسی ارشد حقوق جزا و جرم‌شناسی – دانشگاه تهران مرکز",
      "کارشناسی حقوق قضایی – دانشگاه تهران جنوب",
      "تحصیل در حوزه‌های حقوق جزا و جرم‌شناسی و حقوق بین‌الملل عمومی، در کنار سال‌ها تجربه حرفه‌ای، پشتوانه علمی مناسبی برای فعالیت‌های مدیریتی و حقوقی ایشان فراهم کرده است.",
      "سوابق حرفه‌ای و مدیریتی",
      "مسعود جوکار درزی پیش از پذیرش مسئولیت مدیریت مؤسسه حقوقی مجد وکیل الرعایا، سابقه فعالیت و همکاری در حوزه مشاوره و امور حقوقی با مجموعه‌های مختلف را داشته است.",
      "از جمله مهم‌ترین سوابق حرفه‌ای ایشان می‌توان به موارد زیر اشاره کرد:",
      "نماینده و مشاور حقوقی معاونت پارلمانی رئیس‌جمهور",
      "نماینده و مشاور حقوقی معاونت تقنینی رئیس‌جمهور",
      "نماینده و مشاور حقوقی مرکز استراتژیک خاورمیانه",
      "نماینده و مشاور حقوقی بنیاد سعدی به ریاست دکتر غلامعلی حداد عادل",
      "دبیرکل حقوقی و انضباطی و عضو عالی ارشد هیئت‌رئیسه در سه کنفدراسیون جهانی ورزش‌های همگانی از قاره آسیا",
      "این سوابق، تجربه گسترده‌ای در زمینه امور حقوقی، تقنینی، سازمانی، مدیریتی و بین‌المللی برای ایشان به همراه داشته است.",
      "مدیرعامل مؤسسه حقوقی مجد وکیل الرعایا",
      "مسعود جوکار درزی در حال حاضر به عنوان مدیرعامل مؤسسه حقوقی مجد وکیل الرعایا فعالیت می‌کند و مسئولیت مدیریت و راهبری این مجموعه را بر عهده دارد.",
      "رویکرد مدیریتی ایشان در مؤسسه بر پایه استفاده از دانش تخصصی حقوق، تجربه عملی و بهره‌گیری از ظرفیت کارشناسان و متخصصان حوزه‌های مختلف حقوقی شکل گرفته است.",
      "هدف از این رویکرد، ارائه خدمات حقوقی تخصصی، منسجم و مبتنی بر بررسی دقیق مسائل و نیازهای حقوقی مراجعان و مجموعه‌های طرف همکاری است.",
      "حوزه‌های تخصصی",
      "با توجه به سوابق تحصیلی و حرفه‌ای، زمینه‌های تخصصی فعالیت و مدیریت حقوقی ایشان شامل موارد زیر است:",
      "حقوق بین‌الملل عمومی",
      "حقوق جزا و جرم‌شناسی",
      "مشاوره و امور حقوقی",
      "امور تقنینی و پارلمانی",
      "مسائل حقوقی سازمان‌ها و نهادها",
      "حقوق و انضباط ورزشی",
      "امور حقوقی و مدیریتی بین‌المللی",
      "مدیریت و راهبری مجموعه‌های حقوقی",
      "تجربه در حوزه‌های بین‌المللی و ورزشی",
      "یکی از بخش‌های قابل توجه در سوابق حرفه‌ای مسعود جوکار درزی، فعالیت در حوزه حقوق و مدیریت ورزشی در سطح بین‌المللی است.",
      "ایشان سابقه فعالیت به عنوان دبیرکل حقوقی و انضباطی و عضو عالی ارشد هیئت‌رئیسه در سه کنفدراسیون جهانی ورزش‌های همگانی از قاره آسیا را در کارنامه خود دارد.",
      "این تجربه، علاوه بر دانش حقوقی، موجب شکل‌گیری سابقه‌ای در زمینه امور حقوقی و انضباطی، ساختارهای مدیریتی و تعاملات سازمانی در سطح بین‌المللی شده است.",
      "رویکرد حرفه‌ای و مدیریتی",
      "مدیریت یک مؤسسه حقوقی نیازمند تلفیق دانش حقوقی، تجربه حرفه‌ای، توانایی مدیریتی و شناخت دقیق از نیازهای مراجعان است. مسعود جوکار درزی با بهره‌گیری از پیشینه علمی و تجربیات حرفه‌ای خود، در جایگاه مدیرعامل مؤسسه حقوقی مجد وکیل الرعایا، بر توسعه فعالیت‌های تخصصی مؤسسه و ارائه خدمات حقوقی حرفه‌ای و هدفمند تمرکز دارد.",
      "ترکیب تحصیلات تخصصی در حقوق جزا و جرم‌شناسی و حقوق بین‌الملل عمومی با سابقه فعالیت در حوزه‌های تقنینی، پارلمانی، دولتی، سازمانی و بین‌المللی، از مهم‌ترین پشتوانه‌های حرفه‌ای ایشان در مدیریت مؤسسه حقوقی مجد وکیل الرعایا محسوب می‌شود.",
    ],
