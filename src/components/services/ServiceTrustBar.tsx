  ...
  return (
    <section className="border-y border-slate-100 bg-white py-12">
      <Container>
        ...
        <Stagger className="mt-8 grid grid-cols-2 gap-6 sm:grid-cols-4" stagger={0.08}>
          {stats.map((stat) => (
            <StaggerItem key={stat.label} variant="scale">
              <div className="rounded-xl border border-slate-100 bg-cream/50 px-4 py-6 text-center">
