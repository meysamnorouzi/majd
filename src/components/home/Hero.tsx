            ...
            <FadeIn delay={0.4} className="lg:hidden">
              <div className="group relative mt-10 overflow-hidden rounded-2xl border border-gold-500/20 shadow-2xl">
                ...
                <div className="absolute right-0 bottom-0 left-0 p-5">
                  ...
                  <p className="text-sm text-gold-400">مدیر عامل موسسه حقوقی مجد</p>
                </div>
              </div>
            </FadeIn>

            <Stagger
              className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:mt-12"
              stagger={0.07}
              delay={0.45}
              immediate
            >
              {stats.map((stat) => (
                <StaggerItem key={stat.label} variant="scale">
                  <div className="rounded-xl border border-white/10 bg-white/5 p-3 text-center backdrop-blur-sm sm:p-4">
